...
| CSS-фреймворк | Bootstrap | 5.3 | Готовые компоненты, не требует дизайнерской работы; есть админ-шаблоны под него |
...
## Версии Python и базовые зависимости (черновик `pyproject.toml`)

Точный список и lock-файл сделает локальный агент в TASK-002. Ориентир:
